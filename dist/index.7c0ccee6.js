...
generateButton.addEventListener("click", ()=>{
    ...
    if (isUppercase.checked) characters += uppercase;
    if (isLowercase.checked) characters += lowercase;
    if (isNumbers.checked) characters += numbers;
    if (isSpecial.checked) characters += special;
